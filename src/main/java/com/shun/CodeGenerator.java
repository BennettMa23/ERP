...
public class CodeGenerator {
    ...
    private static String author ="shun";//作者名称
    private static String outputDir ="E:\\ERP-Dev\\erp\\src\\main\\java\\";//生成的位置
    ...
    private static String parentPackage = "com.shun";//顶级包结构
